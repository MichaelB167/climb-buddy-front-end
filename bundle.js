...
/***/ function(module, exports, __webpack_require__) {
	...
	var authClimbUi = __webpack_require__(10);
	...
	var addHandlers = function addHandlers() {
	    ...
	    $('.content-display').on('click', '.update-climb', function (event) {
	        event.preventDefault();
	        var id = $(event.target).attr("data-climb-id");
	    ...
	    $('.delete-climb-btn').on('click', function (event) {
	        //get data, prevents default
	        event.preventDefault();
	        var id = $(this).attr("data-climb-id");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGyms = function getGyms(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/gyms',
	    dataType: 'json',
	...
	var getClimbs = function getClimbs(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/climbs',
	    dataType: 'json',
	...
	var createGym = function createGym(success, failure, data) {
	  $.ajax({
	    method: "POST",
	    url: app.api + '/gyms',
	    dataType: 'json',
	...
	var createClimb = function createClimb(success, failure, data) {
	  $.ajax({
	    method: "POST",
	    url: app.api + '/climbs',
	    dataType: 'json',
	...
	var updateClimb = function updateClimb(success, failure, data, climb_id) {
	  $.ajax({
	    method: "PATCH",
	...
	var deleteClimb = function deleteClimb(success, failure, climb_id) {
	  $.ajax({
	    url: app.api + '/climbs/' + climb_id,
	    method: "DELETE",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(7);
	var climbApi = __webpack_require__(8);
	var climbUi = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createClimbSuccess = function createClimbSuccess(data) {
	...
	module.exports = {
	  createClimbSuccess: createClimbSuccess,
	  createGymSuccess: createGymSuccess,
	  getGymsSuccess: getGymsSuccess,
	  getClimbsSuccess: getClimbsSuccess,
	  updateClimbSuccess: updateClimbSuccess,
	  deleteClimbSuccess: deleteClimbSuccess,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"climb-list\" data-climb-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n       Route Type: "
	    + alias4(((helper = (helper = helpers.route_type || (depth0 != null ? depth0.route_type : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"route_type","hash":{},"data":data}) : helper)))
	    + "<br/> Route Grade: 5. "
	    + alias4(((helper = (helper = helpers.route_grade || (depth0 != null ? depth0.route_grade : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"route_grade","hash":{},"data":data}) : helper)))
	    + "<br/> Last Hold: "
	    + alias4(((helper = (helper = helpers.hold_type_of_fall || (depth0 != null ? depth0.hold_type_of_fall : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"hold_type_of_fall","hash":{},"data":data}) : helper)))
	    + "<br/> Fall Notes: "
	    + alias4(((helper = (helper = helpers.fall_notes || (depth0 != null ? depth0.fall_notes : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"fall_notes","hash":{},"data":data}) : helper)))
	    + "<br/>\n\n      <div class=update-delete-modals>\n        <button class=\"btn btn-primary btn-md update-climb\" data-toggle=\"modal\" data-target=\"#updateClimbModal\" data-climb-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Update</button>\n        <button class=\"btn btn-primary btn-md delete-climb\" data-toggle=\"modal\" data-target=\"#deleteClimbModal\" data-climb-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete</button>\n      </div>\n    </div>\n";
